...
schema_view = get_schema_view(
    openapi.Info(title="Yivi API", default_version="v1",
...
urlpatterns = [
    ...
    path(
        "v1/organizations/<uuid:pk>/relying-party",
    ...
    path(
        "v1/relying-party/<str:slug>/status/",
