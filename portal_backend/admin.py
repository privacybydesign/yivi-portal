...
class OrganizationAdmin(admin.ModelAdmin):
    list_display = ('name_en', 'registration_number',
...
class YiviTrustModelEnvAdmin(admin.ModelAdmin):
    list_display = ('trust_model', 'environment',
                    'timestamp_server', 'keyshare_server')
...
class CondisconAttributeAdmin(admin.ModelAdmin):
    list_display = ('credential_attribute', 'condiscon_id',
                    'reason_en', 'reason_nl')
